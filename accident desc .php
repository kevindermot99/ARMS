                    ...
                    <div class="flex items-center p-[6px]">
                        ...
                        <div class="flex flex-col">
                            <p
                                ...
                                $result=mysqli_fetch_query($conn,$sql); 
    ...
    <nav
        ...
        <div class="h-full w-full flex items-center justify-end gap-0 relative">
            ...
            <button id="toggleButton"
                ...
                <p class="pl-2 capitalize text-sm whitespace-nowrap truncate text-ellipsis max-w-[120px]">
                </p>
...
<style>
    ...
    <!-- Slider --><section class="backgroundd w-full h-fit flex items-center justify-center flex-col py-12 max-md:py-8 gap-4 px-10 max-md:px-4">
                <center><h1 class="text-3xl font-extrabold leading-7 tracking-normal uppercase textify">
                <?php
                                ...
                                echo $row['acc-title']; }
                                // gisozi impanuka yabanyonzi babiri nigikamyo cya HOHO 
                                ?>    
                </h1></center> 
            </section>
                    ...
                    <div class="max-w-[450px] w-[95%] absolute bottom-3 left-3 h-fit flex flex-col gap-[2px] bg-white py-3 px-4 rounded-sm">
                        ...
                        <?php
                                ...
                                while($row=mysqli_fetch_assoc($result)){
                                    ...
                                    <?php
                                echo $row['acc-location'];-
                                echo $row['acc-datetime'];
                             }
                            //  Feb 02 2024 - 08:39 PM
        ...
        <div class="flex-1 h-full flex flex-col gap-4 relative">
            ...
            <div class="columnflex">
                <div class="px-5 max-md:px-0 py-3 w-fit scroll-m-14" id="basic-info">
                    ...
                    <p class="text-base leading-5 font-small py-2">
                        on  
                        <?php
                        $sql="select * from accident"
                        $result=mysqli_fetch_query($conn,$sql); 
                        ...
                        // gisozi impanuka yabanyonzi babiri nigikamyo cya HOHO 
                        ?> 
                        <!-- On August 5, 2023, a multi-vehicle collision occurred on Highway 45 involving four cars. The accident happened at 3:45 PM and resulted in two fatalities and multiple injuries. The involved vehicles were severely damaged, and the highway was closed for five hours for investigation and clearing operations. -->
                    </p>
                </div>
                <div class="px-5 max-md:px-0 py-3 w-fit scroll-m-14" id="forensic-report">
                    <h1 class="text-md font-semibold">Forensic Report</h1>
                    <p class="text-base leading-5 font-small py-2">The forensic analysis indicated that the collision was caused by a combination of speeding and wet road conditions. Vehicle 2 was identified as the initial point of collision after hydroplaning and losing control. The forensic team found traces of alcohol in the driver's blood, exceeding the legal limit.</p>
                    <div class="faq-content">
                        <div class="faq-question">
                          ...
                          <div class="panel-content">
                              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhCUjmh6B643bENHl_8h2B27kHQwoMiM5L4Q&s" alt="">
                              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhCUjmh6B643bENHl_8h2B27kHQwoMiM5L4Q&s" alt=""> 
                          </div>
                        </div> 
                    </div>
                ...
                <div class="px-5 max-md:px-0 py-3 w-fit scroll-m-14" id="testimonials">
                    ...
                    <div class="py-2">
                        ...
                        <ul>
                            ...
                            <li>What Happened: John witnessed the accident from his vehicle, which was three cars behind the initial collision. He confirmed the roads were slippery and visibility was low.</li>
                        </ul>
                    </div>
                    <div class="faq-content">
                        <div class="faq-question">
                    ...
                    <div class="py-2">
                        ...
                        <ul>
                            ...
                            <li>What Happened: Jane was directly involved in the accident. Her car was hit from behind and pushed into the car in front of her. She sustained minor injuries and was treated at the scene.</li>
                        </ul>
                    </div> 
                    <div class="faq-content">
                        <div class="faq-question">
                ...
                <div class="px-5 max-md:px-0 py-3 w-fit scroll-m-14" id="damage-report">
                    ...
                    <p class="text-base leading-5 font-small py-2">All four vehicles involved in the accident were significantly damaged. Vehicle 1 and Vehicle 2 were declared total losses, while Vehicle 3 and Vehicle 4 sustained major front and rear-end damage. The total estimated cost of the damage is approximately $150,000.</p>
                    <div class="faq-content">
                        <div class="faq-question">
                ...
                <div class="px-5 max-md:px-0 py-3 w-fit scroll-m-14" id="officers-report">
                    ...
                    <p class="text-base leading-5 font-small py-2">Officer Brian Thompson reported that upon arrival at the scene, emergency services were already attending to the injured. The road was closed off immediately, and traffic was redirected. Officer Thompson noted the presence of alcohol in the driver of Vehicle 2 and emphasized the adverse weather conditions contributing to the crash.</p>
                    <div class="faq-content">
                        <div class="faq-question">
                ...
                <div class="px-5 max-md:px-0 py-3 w-fit scroll-m-14" id="extra-info">
                    ...
                    <p class="text-base leading-5 font-small py-2">Additional details include the response time of emergency services, which was under ten minutes. The highway was fully reopened at approximately 9:00 PM. Further investigations are ongoing to determine any other contributing factors.</p>
                    <div class="faq-content">
                        <div class="faq-question">
