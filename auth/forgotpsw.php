...
<div class="container" id="container">
	...
	<script>
		...
		function showInput(option) {
			document.getElementById('badge-id-input').style.display = 'none';
			document.getElementById('email-input').style.display = 'none';
			document.getElementById('username-input').style.display = 'none';
	
			if (option === 'badge-id') {
				document.getElementById('badge-id-input').style.display = 'block';
	...
	<div class="form-container sign-in-container">
		<form action="#">
			<h1>psw recovery</h1>
				<div class="texth1">provide recovery Email </div>
			<div class="social-container">
				...
				<!-- <div class="flexify">
				<div class="ok">
					<a href="#" onclick="showInput('email')"  class="social">
				...
				<div class="ok">
				<a href="#" onclick="showInput('badge-id')" class="social">
				...
				<div class="ok">
					<a href="#" onclick="showInput('username')" class="social">
			...
			<!-- <input type="text" id="badge-id-input" placeholder="bdg-123 " /> -->
			<input type="email" id="email-input" placeholder="Email" />
			<!-- <input type="text" id="username-input" placeholder="username " />  -->
            <br>
			<button>Sign In</button>
			<a href="signin.html">Remembered my Password 😅</a>
		</form>
	</div>
